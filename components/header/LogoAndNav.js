            ...
            <div className="u-header__section">
                <Container id="logoAndNav">
                     ...
                     <Navbar className="js-mega-menu navbar-expand-md u-header__navbar u-header__navbar--no-space">
                         {/* <!-- White Logo --> */}
                         <NavbarBrand className="u-header__navbar-brand u-header__navbar-brand-center u-header__navbar-brand-default" aria-label="Front" href="/">
                        ...
                        <UncontrolledCollapse id="navBar" toggler="#toggler"  navbar className="u-header__navbar-collapse">
                            <Nav navbar className="u-header__navbar-nav">
                                ...
                                <MenuItem 
                                    ...
                                    <div className="u-header__mega-menu-wrapper">
                                        ...
                                        <Col sm="6">
                                            <Nav className="u-header__sub-menu-nav-group">
                                            <li><NavLink className="u-header__sub-menu-nav-link" href="#">Classic</NavLink></li>
                                            <li><NavLink className="u-header__sub-menu-nav-link" href="#">Masonry</NavLink></li>
                                            <li><NavLink className="u-header__sub-menu-nav-link" href="#">Single Product</NavLink></li>
                                            </Nav>
                                        </Col>

                                        <Col sm="6">
                                            <Nav className="u-header__sub-menu-nav-group">
                                            <li><NavLink className="u-header__sub-menu-nav-link" href="#">Cart</NavLink></li>
                                            <li><NavLink className="u-header__sub-menu-nav-link" href="#">Checkout</NavLink></li>
                                            </Nav>
                                        </Col>
                                        </Row>
                                    </div>
                                    ...
                                    <div className="u-header__product-banner">
                                        ...
                                        <img className="img-fluid mr-4" src="../../static/img/mockups/img4.png" alt="Image Description" />
                                        <div className="u-header__product-banner-content">
                                            ...
                                            <Button size="sm" className="btn-soft-primary transition-3d-hover" href="#">Learn More <FontAwesomeIcon icon={faAngleRight} className="ml-2" /></Button>
                                        </div>
                                        </div>
                                    </div>
                                </MenuItem>
                                    ...
                                    <Row noGutters>
                                        ...
                                        <div className="u-header__promo-item">
                                            ...
                                            <div className="media align-items-center">
                                                <ReactSVG className="js-svg-injector u-header__promo-icon" src="../../static/svg/icons/icon-13.svg" alt="SVG" />
                                        ...
                                        <div className="u-header__promo-item">
                                            <a className="u-header__promo-link" href="#">
                                            <div className="media align-items-center">
                                                <ReactSVG className="js-svg-injector u-header__promo-icon" src="../../static/svg/icons/icon-19.svg" alt="SVG" />
                                                <div className="media-body">
                                        ...
                                        <div className="u-header__promo-item">
                                            <a className="u-header__promo-link" href="#">
                                            <div className="media align-items-center">
                                                <ReactSVG className="js-svg-injector u-header__promo-icon" src="../../static/svg/icons/icon-5.svg" alt="SVG" />
                                                <div className="media-body">
                                        ...
                                        {/* <!-- Promo --> */}
                                        <Col md="6" className="u-header__promo">
                                        <a className="d-block u-header__promo-inner" href="#">
                                            <div className="position-relative">
                                            <img className="img-fluid rounded mb-3" src="../../static/img/380x227/img6.jpg" alt="Image Description" />
                                ...
                                <NavItem className="nav-item u-header__nav-last-item">
                                    <div className="position-relative">
                                    <a id="signUpDropdownInvoker" className="btn btn-sm btn-outline-primary" href="javascript:;" role="button"
                                    ...
                                    <ItemWith as="NavItem" as="div" id="signUpDropdown" className="dropdown-menu dropdown-unfold dropdown-menu-right py-0" min="350px">
                                        ...
                                        <form className="js-validate">
                                            ...
                                            <div className="card-body p-5">
                                                ...
                                                <a className="js-animation-link link-muted" href="javascript:;"
                                                ...
                                                <a className="js-animation-link" href="javascript:;"
                                                    data-target="#signup"
                                                    data-link-group="idForm"
