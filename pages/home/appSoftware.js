    ...
    <React.Fragment>
        ...
        <div id="SVGHero" className="gradient-overlay-half-indigo-v1 position-relative overflow-hidden">
            <Container className="space-2 space-top-md-5 space-top-lg-4">
                ...
                <div className="mb-5">
                    <h1 className="display-4 font-size-md-down-5 font-weight-medium mb-3">The <span className="text-primary">#1</span> software development tool.</h1>
                    <p className="lead">Front Software is built for every member of your software team to plan, track, and release great software.</p>
                </div>
                <Button className="btn btn-soft-indigo btn-wide transition-3d-hover" href="#">
                    Contact Sales
                ...
                <Button color="primary" className="btn btn-primary btn-wide transition-3d-hover" href="#">See Pricing</Button>
                </div>
            </Container>
            ...
            <Container className="space-2">
                <div className="position-relative w-lg-75 text-center mx-lg-auto">
                    <div className="position-relative shadow-lg z-index-2 rounded-lg">
                        <img className="img-fluid rounded-lg" src="../../static/img/1618x1010/img3.jpg" alt="Image Description" />
                    </div>
        ...
        <Container className="space-1">
            <div className="w-lg-75 mx-lg-auto">
                <div className="text-center mb-4">
                    <h2 className="u-divider u-divider--text">Trusted by the world's best</h2>
                </div>

                <Row className="justify-content-between text-center">
                    <Col xs="4" lg="2" className="mb-5 mb-lg-0">
                        <div className="mx-4">
                        <ReactSVG className="u-clients" src="../../static/svg/clients-logo/amazon.svg" alt="Image Description" />
                        </div>
                    </Col>
                    <Col xs="4" lg="2" className="mb-5 mb-lg-0">
                        <div className="mx-4">
                        <ReactSVG className="u-clients" src="../../static/svg/clients-logo/netflix.svg" alt="Image Description" />
                        </div>
                    </Col>
                    <Col xs="4" lg="2" className="mb-5 mb-lg-0">
                        <div className="mx-4">
                        <ReactSVG className="u-clients" src="../../static/svg/clients-logo/paypal.svg" alt="Image Description" />
                        </div>
                    </Col>
                    <Col xs="4" lg="2">
                        <div className="mx-4">
                        <ReactSVG className="u-clients" src="../../static/svg/clients-logo/slack.svg" alt="Image Description" />
                        </div>
                    </Col>
                    <Col xs="4" lg="2">
                        <div className="mx-4">
                        <ReactSVG className="u-clients" src="../../static/svg/clients-logo/samsung.svg" alt="Image Description" />
                        </div>
                    </Col>
                    <Col xs="4" lg="2">
                        <div className="mx-4">
                        <ReactSVG className="u-clients" src="../../static/svg/clients-logo/stripe.svg" alt="Image Description" />
                        </div>
                    </Col>
                </Row>
            </div>
        ...
        <Container className="space-2 space-lg-3">
            <Row className="align-items-lg-center">
                ...
                <div className="mb-5">
                    <h2 className="font-weight-medium">Lightning-fast development with pre-built solutions</h2>
                ...
                <ul className="list-unstyled">
                    ...
                    <div className="media-body">
                        <p className="text-dark mb-0">Extensive API documentation</p>
                    </div>
                    </li>
                    ...
                    <div className="media-body">
                        <p className="text-dark mb-0">Customizable &amp; open source</p>
                    </div>
                    </li>
                    ...
                    <div className="media-body">
                        <p className="text-dark mb-0">Continiously improved</p>
                    </div>
                    </li>
                </ul>
                {/* <!-- End Info --> */}
                ...
                <div className="col-lg-7 order-lg-1">
                    ...
                    <div id="featuresSVG1" className="pr-lg-4">
                        <div className="card border-0 bg-soft-primary text-indigo text-center w-lg-75 overflow-hidden pt-9 px-5 mx-lg-auto">
                        <div className="px-5 mb-5">
                            <h3 className="h6">Choose a workflow, or make your own with Front Software</h3>
                        </div>

                        {/* <!-- SVG Phone Mockup --> */}
                        <div className="w-85 u-devices-v2__phone-svg shadow-sm mx-auto">
                            <figure className="ie-half-iphone-x-1-iphone">
                            <ReactSVG className="js-svg-injector" src="../../static/svg/components/half-iphone-x-1.svg" alt="Image Description"
        ...
        <div className="w-lg-85 mx-lg-auto">
            ...
            <Row className="justify-content-md-start align-items-md-center text-center text-md-left">
                ...
                <h3 className="h4 text-indigo font-weight-medium mb-0">Revolutionizing the way your team works!</h3>
                </div>

                <div className="col-md-4 text-md-right">
                <a className="btn btn-primary transition-3d-hover" href="#">Explore Docs</a>
                </div>
            </Row>
        ...
        <Row className="align-items-lg-center">
            <div className="col-lg-5 mb-7 mb-lg-0">
                <div className="mb-5">
                    <h2 className="font-weight-medium">The best software teams ship early and often.</h2>
                ...
                <ul className="list-unstyled">
                    ...
                    <div className="media-body">
                        <p className="text-dark mb-0">Knowledge management</p>
                    </div>
                    </li>
                    ...
                    <div className="media-body">
                        <p className="text-dark mb-0">Development workflow</p>
                    </div>
                    </li>
                    ...
                    <div className="media-body">
                        <p className="text-dark mb-0">Continuous integration</p>
                    </div>
                    </li>
                </ul>
                {/* <!-- End Info --> */}
            ...
            <div id="featuresSVG2" className="pl-lg-4">
                <div className="card border-0 bg-soft-info text-indigo text-center w-lg-75 overflow-hidden pt-9 px-5 mx-lg-auto">
                <div className="px-5 mb-5">
                    <h3 className="h6">Integrate with the tools and workflow you already use</h3>
                </div>
        ...
        <div className="position-relative gradient-overlay-half-primary-v3 overflow-hidden">
            <Container className="space-top-2 space-top-lg-3">
                ...
                <h2 className="text-white font-weight-medium">Go Front with ease.</h2>
                <p className="text-white-70">Whether you’re a seasoned agile expert, or just getting started, Jira Software unlocks the power of agile.</p>
                </div>
                {/* <!-- End Title --> */}
                ...
                <div className="w-lg-80 mx-lg-auto mb-11">
                    <Row className="mb-9">
                        ...
                        {/* <!-- Icon Block --> */}
                        <span className="d-block text-white font-size-2 mb-3">
                            <FontAwesomeIcon icon={faAlignCenter} />
                        </span>
                        <h4 className="h6 text-white font-weight-semi-bold mb-3">Flexible planning</h4>
                        <p className="text-white-70">Front Software's rich planning features enable your team to flexibly plan.</p>
                        {/* <!-- End Icon Block --> */}
                        </div>
                        ...
                        <h4 className="h6 text-white font-weight-semi-bold mb-3">Accurate estimations</h4>
                        <p className="text-white-70">Use story points, hours, t-shirt sizes, or your own estimation technique.</p>
                        {/* <!-- End Icon Block --> */}
                        </div>
                        ...
                        <h4 className="h6 text-white font-weight-semi-bold mb-3">Value-driven prioritization</h4>
                        <p className="text-white-70">Order user stories, issues, and bugs in your product backlog with simple dragging.</p>
                        {/* <!-- End Icon Block --> */}
                        </div>
                        ...
                        <h4 className="h6 text-white font-weight-semi-bold mb-3">Transparent execution</h4>
                        <p className="text-white-70">Front Software brings a new level of transparency to your team's work.</p>
                        {/* <!-- End Icon Block --> */}
                        </div>
                        ...
                        <h4 className="h6 text-white font-weight-semi-bold mb-3">Actionable results</h4>
                        <p className="text-white-70">Extensive reporting functionality gives your team critical insight into their agile process.</p>
                        {/* <!-- End Icon Block --> */}
                        </div>
                        ...
                        <h4 className="h6 text-white font-weight-semi-bold mb-3">Scalable evolution <span className="badge badge-warning font-weight-medium badge-pill ml-1">Coming soon</span></h4>
                        <p className="text-white-70">Front Software is agile project management designed for any teams.</p>
                        {/* <!-- End Icon Block --> */}
                        </div>
                    </Row>
                    ...
                    <div className="text-center">
                        <div className="mb-3">
                            ...
                            <small className="d-block d-sm-inline-block text-white-70 my-3 my-sm-0 mx-sm-3">or</small>
                            <a className="btn btn-sm btn-indigo btn-wide transition-3d-hover" href="#">Talk to our Experts</a>
                        </div>
                        <p className="small text-white-70">Start free trial. * No credit card required.</p>
                    </div>
                    {/* <!-- End Buttons --> */}
                </div>
                {/* <!-- End Icon Blocks --> */}
